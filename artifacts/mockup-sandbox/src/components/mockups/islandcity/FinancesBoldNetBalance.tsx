...
// ── FINANCES BOLD v2.1 — Net Balance Card added ─────────────────────────
// Layout: IC brand header → SuperPlus Net Balance Card → 
//         Hourly Earnings Advisor (speedometer) → Target vs Actual → 
//         Performance History → Advisor Panel → Daily Goal Ring
...
export function FinancesBoldNetBalance() {
  const perHour   = 65;
  ...
  return (
    <div style={{ minHeight: "100vh", width: "100%", background: "#000", color: "#fff",
      ...
      <div style={{ maxWidth: 390, margin: "0 auto", paddingBottom: 20 }}>
        ...
        {/* ── SUPERPLUS NET BALANCE CARD ──────────────────────────────────── */}
        <div style={{ margin: "12px 12px 0",
          background: "linear-gradient(145deg, #1f1803 0%, #0d0a00 100%)", 
          border: "1px solid #d9b64f44", 
          boxShadow: "0 8px 32px rgba(217, 182, 79, 0.05)",
          borderRadius: 22, padding: "20px" }}>
          
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
            <p style={{ margin: 0, fontSize: 10, color: "#d9b64f", textTransform: "uppercase", letterSpacing: "0.15em", fontWeight: 700, opacity: 0.9 }}>
              Net Balance • Sept
            </p>
            <span style={{
              fontSize: 9, color: "#d9b64f", background: "#d9b64f15",
              border: "1px solid #d9b64f33", borderRadius: 999, padding: "3px 9px", fontWeight: 600
            }}>SUPERPLUS</span>
          </div>
          
          <p style={{ margin: "0 0 20px", fontSize: 44, fontWeight: 900, color: "#f6dd8c", fontFamily: "JetBrains Mono,monospace", lineHeight: 1 }}>
            +$1,840
          </p>

          <div style={{ display: "flex", gap: 12, marginBottom: 20 }}>
            <div style={{ flex: 1, background: "rgba(0,0,0,0.4)", border: "1px solid rgba(217,182,79,0.1)", borderRadius: 14, padding: "12px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#4ade80" }} />
                <p style={{ margin: 0, fontSize: 9, color: "#a07820", textTransform: "uppercase", letterSpacing: "0.1em", fontWeight: 600 }}>Income</p>
              </div>
              <p style={{ margin: 0, fontSize: 18, fontWeight: 800, color: "#fff", fontFamily: "JetBrains Mono,monospace" }}>$4,200</p>
            </div>
            <div style={{ flex: 1, background: "rgba(0,0,0,0.4)", border: "1px solid rgba(217,182,79,0.1)", borderRadius: 14, padding: "12px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#ef4444" }} />
                <p style={{ margin: 0, fontSize: 9, color: "#a07820", textTransform: "uppercase", letterSpacing: "0.1em", fontWeight: 600 }}>Expenses</p>
              </div>
              <p style={{ margin: 0, fontSize: 18, fontWeight: 800, color: "#fff", fontFamily: "JetBrains Mono,monospace" }}>$2,360</p>
            </div>
          </div>

          <div>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
              <p style={{ margin: 0, fontSize: 9, color: "#a07820", textTransform: "uppercase", fontWeight: 700, letterSpacing: "0.1em" }}>Month Progress</p>
              <p style={{ margin: 0, fontSize: 9, color: "#d9b64f", fontWeight: 700, fontFamily: "JetBrains Mono,monospace" }}>18 / 30 Days</p>
            </div>
            <div style={{ width: "100%", height: 6, background: "rgba(0,0,0,0.5)", borderRadius: 3, overflow: "hidden" }}>
              <div style={{ width: "60%", height: "100%", background: "linear-gradient(90deg, #d9b64f, #f6dd8c)", borderRadius: 3 }} />
            </div>
          </div>
        </div>
